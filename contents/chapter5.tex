...
当提及的参考文献为文中直接说明时，则用小四号字与正文排齐，如``由文献\citep{knuth1984texbook,lamport1994latex,mittelbach2004latex,gbt77142015,wang2007latex} 可知''。
...
\end{demoenv}
 ...
 文献类型和标志代码参见表\ref{tab:littype}.
 \begin{table}[htbp]
 \centering
 \caption{文献类型和标志代码 \label{tab:littype}}
 \zihao{-5}\songti
 \begin{tabular}{ll}
 \toprule
 文献类型 & 标志代码 \\
 ...
 电子文献载体和标志代码参见表\ref{tab:litcarrier}.
 \begin{table}[htbp]
 \centering
 \caption{电子文献载体和标志代码 \label{tab:litcarrier}}
 \zihao{-5}\songti
 \begin{tabular}{ll}
 \toprule
 载体类型 & 标志代码 \\
 ...
 （你看到这两个表的排版感觉跟tex文件中的顺序不一样，这是正常现象，因为\LaTeX 会自动调整表格的顺序以适应页面布局。不要尝试手动调整表格的顺序，否则会导致排版错误。）
